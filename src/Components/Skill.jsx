...
const Skill = () => {
  return (
    ...
    <div class="skill2">
        <img src="./image/HTML.png" width="100px" height="100px" id="skill5"/>
          <img src="./image/CSS.png" width="100px" height="100px" id="skill5" />
          <img src="./image/Javascript.png" width="100px" height="100px" id="skill5" />
          <img src="./image/reactjs.png" width="100px" height="100px"/>
          <img src="./image/sql.svg" width="100px" height="100px"/>
           <img src="./image/java.png" width="100px" height="100px"/>
          <img src="./image/spring.svg" width="100px" height="100px"/> 
          <img src="./image/springboot.svg" width="100px" height="100px"/>
          <img src="./image/github.svg" width="100px" height="100px"/>
    </div>
</main>
    </div>
  )
